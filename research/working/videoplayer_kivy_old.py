...
Spits out error and warnings, but still works. Runs from the command line.
Name of video is supplied as an argument.
...
the video. By default, if the video is smaller than the Window, it won't be
stretched.
